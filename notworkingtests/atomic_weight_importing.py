...
def test_isotopic_composition_o_16():
    ...
    # Ensure the Mass Number column is treated as an integer
    isotope_data["Mass Number"] = isotope_data["Mass Number"].astype(int)
    ...
    o_rows = isotope_data[isotope_data["Elemental Symbol"] == "Cu"]
    print("All rows for Elemental Symbol O:")
    ...
    relevant_rows = isotope_data[
        (isotope_data["Elemental Symbol"] == "Cu") & (isotope_data["Mass Number"] == 65)
    ]

    # Debug: Print the filtered DataFrame
    print("Filtered DataFrame for Elemental Symbol O and Mass Number 16:")
    print(relevant_rows)
    ...
    assert (
        relevant_rows["Isotopic Composition"].iloc[0] == "0.3085"
...
if __name__ == "__main__":
    pytest.main(["-k", "test_isotopic_composition_o_16"])
