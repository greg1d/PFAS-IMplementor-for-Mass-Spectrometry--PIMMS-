...
OutputBaseFilename=PIMMS_v1.2.1_Setup
...
Source: "F:\PFAS-IMplementor-for-Mass-Spectrometry--PIMMS-\PIMMS v1.2\Raw data\Training data set raw feature list.csv"; DestDir: "{userdocs}\PIMMS\Raw data"; Flags: ignoreversion
