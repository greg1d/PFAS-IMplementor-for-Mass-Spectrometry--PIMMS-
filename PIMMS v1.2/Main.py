...
def main():
    # File paths
    raw_data_input_location = [r"PIMMS v1.2\data\Dummy test blank subtracted data.csv"]
    ...
    try:
        ...
        combined_data = process_and_combine_files(raw_data_input_location)
    ...
    print("[INFO] Applying adduct filter...")
    try:
